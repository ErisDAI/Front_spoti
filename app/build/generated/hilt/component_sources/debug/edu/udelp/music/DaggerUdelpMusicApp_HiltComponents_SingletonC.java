...
import edu.udelp.music.di.AppModule_ProvideAuthApiFactory;
...
import edu.udelp.music.ui.auth.RegisterViewModel;
import edu.udelp.music.ui.auth.RegisterViewModel_HiltModules;
import edu.udelp.music.ui.home.HomeViewModel;
import edu.udelp.music.ui.home.HomeViewModel_HiltModules;
import edu.udelp.music.ui.home.PlayerViewModel;
import edu.udelp.music.ui.home.PlayerViewModel_HiltModules;
import edu.udelp.music.ui.search.SearchViewModel;
import edu.udelp.music.ui.search.SearchViewModel_HiltModules;
...
public final class DaggerUdelpMusicApp_HiltComponents_SingletonC {
  private DaggerUdelpMusicApp_HiltComponents_SingletonC() {
  }
  ...
  public static final class Builder {
    ...
    public UdelpMusicApp_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      return new SingletonCImpl(applicationContextModule);
    }
  }

  private static final class ActivityRetainedCBuilder implements UdelpMusicApp_HiltComponents.ActivityRetainedC.Builder {
    ...
    @Override
    public UdelpMusicApp_HiltComponents.ActivityRetainedC build() {
      Preconditions.checkBuilderRequirement(savedStateHandleHolder, SavedStateHandleHolder.class);
      return new ActivityRetainedCImpl(singletonCImpl, savedStateHandleHolder);
    }
  }

  private static final class ActivityCBuilder implements UdelpMusicApp_HiltComponents.ActivityC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public UdelpMusicApp_HiltComponents.ActivityC build() {
      Preconditions.checkBuilderRequirement(activity, Activity.class);
      return new ActivityCImpl(singletonCImpl, activityRetainedCImpl, activity);
    }
  }

  private static final class FragmentCBuilder implements UdelpMusicApp_HiltComponents.FragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public UdelpMusicApp_HiltComponents.FragmentC build() {
      Preconditions.checkBuilderRequirement(fragment, Fragment.class);
      return new FragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragment);
    }
  }

  private static final class ViewWithFragmentCBuilder implements UdelpMusicApp_HiltComponents.ViewWithFragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public UdelpMusicApp_HiltComponents.ViewWithFragmentC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewWithFragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragmentCImpl, view);
    }
  }

  private static final class ViewCBuilder implements UdelpMusicApp_HiltComponents.ViewC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public UdelpMusicApp_HiltComponents.ViewC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, view);
    }
  }

  private static final class ViewModelCBuilder implements UdelpMusicApp_HiltComponents.ViewModelC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public UdelpMusicApp_HiltComponents.ViewModelC build() {
  ...
  private static final class ServiceCBuilder implements UdelpMusicApp_HiltComponents.ServiceC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public UdelpMusicApp_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(singletonCImpl, service);
    }
  }

  private static final class ViewWithFragmentCImpl extends UdelpMusicApp_HiltComponents.ViewWithFragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class FragmentCImpl extends UdelpMusicApp_HiltComponents.FragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewCImpl extends UdelpMusicApp_HiltComponents.ViewC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityCImpl extends UdelpMusicApp_HiltComponents.ActivityC {
    private final SingletonCImpl singletonCImpl;
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(ImmutableMap.<String, Boolean>builderWithExpectedSize(6).put(LazyClassKeyProvider.edu_udelp_music_ui_account_AccountViewModel, AccountViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.edu_udelp_music_ui_home_HomeViewModel, HomeViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.edu_udelp_music_ui_auth_LoginViewModel, LoginViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.edu_udelp_music_ui_home_PlayerViewModel, PlayerViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.edu_udelp_music_ui_auth_RegisterViewModel, RegisterViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.edu_udelp_music_ui_search_SearchViewModel, SearchViewModel_HiltModules.KeyModule.provide()).build());
    }
  ...
  private static final class ViewModelCImpl extends UdelpMusicApp_HiltComponents.ViewModelC {
    private final SingletonCImpl singletonCImpl;
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(ImmutableMap.<String, javax.inject.Provider<ViewModel>>builderWithExpectedSize(6).put(LazyClassKeyProvider.edu_udelp_music_ui_account_AccountViewModel, ((Provider) accountViewModelProvider)).put(LazyClassKeyProvider.edu_udelp_music_ui_home_HomeViewModel, ((Provider) homeViewModelProvider)).put(LazyClassKeyProvider.edu_udelp_music_ui_auth_LoginViewModel, ((Provider) loginViewModelProvider)).put(LazyClassKeyProvider.edu_udelp_music_ui_home_PlayerViewModel, ((Provider) playerViewModelProvider)).put(LazyClassKeyProvider.edu_udelp_music_ui_auth_RegisterViewModel, ((Provider) registerViewModelProvider)).put(LazyClassKeyProvider.edu_udelp_music_ui_search_SearchViewModel, ((Provider) searchViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // edu.udelp.music.ui.account.AccountViewModel 
          return (T) new AccountViewModel(singletonCImpl.provideAuthApiProvider.get());

          case 1: // edu.udelp.music.ui.home.HomeViewModel 
          return (T) new HomeViewModel(singletonCImpl.provideCatalogApiProvider.get());

          case 2: // edu.udelp.music.ui.auth.LoginViewModel 
          return (T) new LoginViewModel(viewModelCImpl.loginUseCase());

          case 3: // edu.udelp.music.ui.home.PlayerViewModel 
          return (T) new PlayerViewModel(singletonCImpl.musicPlayerManagerProvider.get());

          case 4: // edu.udelp.music.ui.auth.RegisterViewModel 
          return (T) new RegisterViewModel(viewModelCImpl.registerUseCase());

          case 5: // edu.udelp.music.ui.search.SearchViewModel 
          return (T) new SearchViewModel(singletonCImpl.provideCatalogApiProvider.get());
  ...
  private static final class ActivityRetainedCImpl extends UdelpMusicApp_HiltComponents.ActivityRetainedC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ServiceCImpl extends UdelpMusicApp_HiltComponents.ServiceC {
    private final SingletonCImpl singletonCImpl;
